...
## 一些问题
- 为什么某天统计的视频少了几个？  
出现这种情况可能是你昨天快结束时观看了几个视频，被存入到本地后，在新的一天刚刚开始时又看了一次这个视频，那么由于去重检测机制，就会去掉新一天的视频而保留昨天的，尝试去掉去重代码，但是会导致很多重复视频被记录，于是放弃了，这种特殊情况或许可以通过控制连续多少条记录重复就停止来解决，我默认的是30条，数字越小解决几率越大，但是最好不要设置低于10以下，避免模糊边界
